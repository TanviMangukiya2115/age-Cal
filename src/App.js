...
function App() {
  ...
  const [todayDate, setToday] = useState(getDefaultTodayDate());
      ...
      <div className="container">
        <form>
          ...
          <div className="name">
            ...
            <h4>Birth Date:</h4>
            <input type="date" value={birthdate} onChange={(e) => setBirth(e.target.value)}></input>
            <h4>Today Date:</h4>
            <input type="date" value={todayDate} onChange={(e) => setToday(e.target.value)}></input>
          </div>
          <div className="btn">
